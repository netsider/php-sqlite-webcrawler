<?php
	$cost = 0;
	$counter = 0;
	$needle = ['.mx', '.br', '.au', 'https', 'Media-Player', 'redirect', 'product-reviews'];
	...
	function crawl($target_url, $needle, $cost){
		$needle = ['.mx', '.br', '.au', 'https', 'Media-Player', 'redirect', 'product-reviews'];
