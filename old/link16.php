...
// Make it so when you click a link, the data from the page is fetched, it's put into a _POSt variable, and sent to a form on another page to add.


//OR

// Make this part of the other scraper. then:

// Modify the best scraper to take the array created by this one.. and we're good.


// Then make a webscraper to do each type (books, video games, etc)
