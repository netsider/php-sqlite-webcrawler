<?php
	...
	$exclude = ['.mx', '.br', '.au', 'https', 'Media-Player', 'redirect', 'product-reviews', 'services.amazon', 'aws.amazon', '#', 'fresh.amazon', 'nav_a', 'onload=', 'void(0)', 'adobe.com', 'javascript', 'footer_logo', 'pd_pyml_rhf', 'gno_joinprmlogo', 'ref=gno_logo', 'Thread=', 'customer-media', 'ref=nav_logo', 'nav_joinprmlogo'];
...
?>
	...
	<td align=center><?PHP if (isset($index)){echo 'Links in Session: ' . $index; } ?><td colspan=1 align=center></td><td align=center>Database</td>
		...
		<tr>
			<td align=center><input type="submit" name="run" value="Crawl URL" /><input type="submit" name="clear" value="Clear Session" /><input type="submit" name="show" value="Show All in Session" /></td>
